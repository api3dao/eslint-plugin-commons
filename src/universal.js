...
module.exports = [
  pluginOverrides.unicorn.configs['flat/recommended'],
  ...compatConfig({
    ...
    plugins: ['@shopify', '@typescript-eslint', 'check-file', 'functional', 'import-x', 'lodash'],
    rules: {
      ...
      // These rules became errors in Unicorn's recommended config. Keep them off for backwards compatibility.
